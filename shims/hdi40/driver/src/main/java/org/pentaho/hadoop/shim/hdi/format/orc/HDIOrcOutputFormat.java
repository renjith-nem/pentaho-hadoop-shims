...
public class HDIOrcOutputFormat extends HadoopFormatBase implements IPentahoOrcOutputFormat {
  ...
  @Override public IPentahoRecordWriter createRecordWriter() {
    ...
    try {
      return new HDIOrcRecordWriter( fields, schema, outputFilename, conf, (FileSystem) shim.getFileSystem(pentahoConf));
    } catch (IOException e) {
